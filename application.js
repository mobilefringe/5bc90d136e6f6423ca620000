var default_image_url = "//codecloud.cdn.speedyrails.net/sites/5bc90d136e6f6423ca620000/image/png/1540916374003/qm-default-logo.png"
...
function renderFeatureItems(){
    ...
    var names = ["ACT GREEN", "NEWSLETTER", "SHOPS", "GIFT CARD", "GUEST SERVICES", "EVENTS", "PROMOTIONS"];
...
function renderHomeHours(container, template, collection){
    ...
    item_list.push(collection);    
    $.each( item_list , function( key, val ) {
        var day = moment(val.day_of_week).format("ddd, hA"); // getDay();
        val.day = day;
